...
const InputForm:NextPage = () =>{
    ...
    return(
        <div className="pt-20 px-12 lg:px-20 grid grid-cols-4 lg:border-l-2">
            ...
            <div className="col-span-4 lg:col-span-3 order-2 mt-8">
                <div>
            ...
            <div className="col-span-4 order-3 lg:order-4 mt-8">
            ...
            <div className="col-span-4 order-4 lg:order-5 mt-8">
            ...
            <div className="col-span-2 lg:col-span-1 order-5 lg:order-3 mt-8 flex justify-start lg:justify-center">
                <div>
            ...
            <div className="col-span-2 order-6 mt-8 ">
                <label className="font-bold" htmlFor="available_qty">Available Qty <small className="text-red-500">*</small></label>
                <div className="mt-4">
                    <input id="available_qty" type="number" className="w-full border-b-2" value={available_qty} onChange={(e)=>setAvailableQty(parseInt(e.target.value))} placeholder="Enter available quanlity" min="0" step="1"  />
                </div>
            </div>
            <div className="col-span-4 order-7 mt-8">
                <label className="font-bold" htmlFor="condition">Condition</label>
                <div className="mt-4">
                    <button onClick={()=>setCondition('bad')} className={`py-1 px-2 lg:w-24 ${condition === 'bad' ? 'bg-black text-white border-solid border-2 border-black' : 'border-gray-900 border-solid border-2' }`}>Bad</button>
                    <button onClick={()=>setCondition('fair')} className={`py-1 px-2 ml-2 lg:w-24 ${condition === 'fair' ? 'bg-black text-white border-solid border-2 border-black' : 'border-gray-900 border-solid border-2' }`}>Fair</button>
                    <button onClick={()=>setCondition('good')} className={`py-1 px-2 ml-2 lg:w-24 ${condition === 'good' ? 'bg-black text-white border-solid border-2 border-black' : 'border-gray-900 border-solid border-2' }`}>Good</button>
                    <button onClick={()=>setCondition('new')} className={`py-1 px-2 ml-2 lg:w-24 ${condition === 'new' ? 'bg-black text-white border-solid border-2 border-black' : 'border-gray-900 border-solid border-2' }`}>New</button>
                </div>
            </div>
            <div className="col-span-2 order-8 mt-8 ">
            ...
            <div className="col-span-2 order-9 mt-8 ml-4 ">
            ...
            <div className="col-span-4 order-10 mt-8">
                <label className="font-bold">Authencity</label>
                <div className="mt-4">
                    <span>100%</span>
                </div>
            </div>
            <div className="col-span-4 order-11 mt-8">
            ...
            <div className="col-span-4 order-12 mt-8">
                ...
                <div className="flex justify-center lg:justify-end mt-4 ">
                    <button className={`py-1 px-2 border-gray-500 border-solid border-2 hover:hover:bg-gray-500 hover:text-white mr-2`}>Cancel</button>
                    <button className={`py-1 px-2 bg-black text-white border-solid border-2 border-black hover:border-white-900 hover:bg-white hover:text-black`}>Publish</button>
                </div>
            </div>
        </div>    
    )
